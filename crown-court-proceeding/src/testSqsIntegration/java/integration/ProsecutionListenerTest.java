...
class ProsecutionListenerTest {
    ...
    void givenAValidMessage_whenListenerIsInvoked_thenShouldCreateWithPending() {
        ...
        with().pollDelay(10, SECONDS)
                ...
                .atMost(30, SECONDS)
                .until(() ->
                        !prosecutionConcludedRepository.getByMaatId(5635566).isEmpty());
    ...
    void givenAnInvalidMessageWithMissingMaatId_whenListenerIsInvoked_thenMessageIsSavedAsADeadLetterMessage() {
        ...
        String queueMessage =
                FileUtils.readFileToString("data/prosecution_concluded/SqsPayloadPleaWithMissingMaatId.json");
    ...
    void givenAppealsConcludedResultIsReceived_whenListenerIsInvoked_thenOutcomeIsSuccesful() {
        ...
        assertThat(requests.get(requests.size() - 1).getBodyAsString())
                .isEqualTo(getExpectedAppealsRequest(SUCCESSFUL));
    }

    private String getExpectedRequest(String outcome, String imprisoned) {
        return "{\"repId\":5635567,\"ccOutcome\":\"" + outcome
                + "\",\"benchWarrantIssued\":null,\"appealType\":\"ACN\",\"imprisoned\":" + imprisoned
