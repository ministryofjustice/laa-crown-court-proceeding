...
class ProsecutionListenerTest {
    ...
    private static final String CC_OUTCOME_URL =
            "/api/internal/v1/assessment/crown-court/updateCCOutcome";
    ...
    @Autowired private ProsecutionConcludedRepository prosecutionConcludedRepository;

    @Autowired private DeadLetterMessageRepository deadLetterMessageRepository;
    ...
    void givenAValidMessage_whenListenerIsInvoked_thenShouldCreateWithPending() {
        ...
        amazonSQS.sendMessage(
                ...
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaAndVerdict.json"));
        ...
        List<ProsecutionConcludedEntity> prosecutionConcludedEntities =
                prosecutionConcludedRepository.getByMaatId(5635566);

        assertThat(prosecutionConcludedEntities).isNotEmpty();
        assertThat(prosecutionConcludedEntities.get(0).getStatus())
                .isEqualTo(CaseConclusionStatus.PENDING.name());
        verify(
                exactly(1),
                getRequestedFor(
                        urlEqualTo(
                                "/api/internal/v1/assessment/wq-hearing/908ad01e-5a38-4158-957a-0c1d1a783862/maatId/5635566")));
        verify(
                exactly(1),
                getRequestedFor(urlEqualTo("/api/internal/v1/assessment/reservations/5635566")));
    }

    @Test
    void
            givenAnInvalidMessageWithMissingMaatId_whenListenerIsInvoked_thenMessageIsSavedAsADeadLetterMessage() {
        deadLetterMessageRepository.deleteAll();
        String queueMessage =
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaWithMissingMaatId.json");
        ProsecutionConcluded expectedMessage =
                gson.fromJson(queueMessage, ProsecutionConcluded.class);
        ...
        assertThat(deadLetterMessageEntity.getDeadLetterReason())
                .isEqualTo(ProsecutionConcludedValidator.PAYLOAD_IS_NOT_AVAILABLE_OR_NULL);
    }
    ...
    void givenAnInvalidMessageWithInvalidMaatId_whenListenerIsInvoked_thenMessageIsNotSaved() {
        ...
        String queueMessage =
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaWithInvalidMaatId.json");
        amazonSQS.sendMessage(queueUrl, queueMessage);
        setScenarioState("reservations", "Started");
        with().pollDelay(10, SECONDS)
                .pollInterval(10, SECONDS)
    ...
    void givenPleaIsGuiltyAndNoVerdict_whenListenerIsInvoked_thenOutcomeIsConvicted() {
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaWithGuilty.json"));
        ...
        assertThat(requests.get(requests.size() - 1).getBodyAsString())
                .isEqualTo(getExpectedRequest(CONVICTED));
    }
    ...
    void givenAPleaNotGuiltyAndNoVerdict_whenListenerIsInvoked_thenOutcomeIsAquitted() {
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaWithNotGuilty.json"));
        setScenarioState("reservations", "State 2");
        ...
        List<LoggedRequest> requests = findAll(putRequestedFor(urlEqualTo(CC_OUTCOME_URL)));
        assertThat(requests.get(requests.size() - 1).getBodyAsString())
                .isEqualTo(getExpectedRequest(AQUITTED, null));
    }
    ...
    void givenAVerdictIsGuiltyAndNoPlea_whenListenerIsInvoked_thenOutcomeIsAConvicted() {
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadVerdictWithGuilty.json"));
        setScenarioState("reservations", "State 2");
    ...
    void givenAVerdictIsNotGuiltyAndNoPlea_whenListenerIsInvoked_thenOutcomeIsAAquitted() {
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadVerdictWithNotGuilty.json"));
        setScenarioState("reservations", "State 2");
    ...
    void givenAPleaIsGuiltyAndVerdictIsGuilty_whenListenerIsInvoked_thenOutcomeIsConvicted() {
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaAndVerdictWithGuilty.json"));
        setScenarioState("reservations", "State 2");
    ...
    void givenAPleaIsNotGuiltyAndVerdictIsNotGuilty_whenListenerIsInvoked_thenOutcomeIsAquitted() {
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsPayloadPleaAndVerdictWithNotGuilty.json"));
        setScenarioState("reservations", "State 2");
    ...
    void givenAMultipleOffenceWithPleaAndNoVerdict_whenListenerIsInvoked_thenOutcomeIsAConvicted() {
        ...
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsMultipleOffenceWithPleaIsGuilty.json"));
    ...
    void givenAMultipleOffence_withPleaIsNotGuiltyAndVerdictIsNotGuilty_thenOutcomeIsAquitted() {
        ...
        amazonSQS.sendMessage(
                queueUrl,
                FileUtils.readFileToString(
                        "data/prosecution_concluded/SqsMultipleOffenceWithNotGuilty.json"));
        setScenarioState("reservations", "State 2");
    ...
    private String getExpectedRequest(String outcome, String imprisoned) {
        return "{\"repId\":5635567,\"ccOutcome\":\""
                + outcome
                + "\",\"benchWarrantIssued\":null,\"appealType\":\"ACN\",\"imprisoned\":"
                + imprisoned
    ...
    private String getExpectedRequest(String outcome) {
        return "{\"repId\":5635567,\"ccOutcome\":\""
                + outcome
                + "\",\"benchWarrantIssued\":null,\"appealType\":\"ACN\",\"imprisoned\":\"N\",\"caseNumber\":\"21GN1208521\",\"crownCourtCode\":\"433\"}";
    }
}
