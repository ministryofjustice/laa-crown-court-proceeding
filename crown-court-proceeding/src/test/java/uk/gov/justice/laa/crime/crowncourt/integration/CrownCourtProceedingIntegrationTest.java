...
class CrownCourtProceedingIntegrationTest extends WiremockIntegrationTest {
    ...
    void givenInvalidContent_whenProcessRepOrderIsInvoked_thenFailsBadRequest() throws Exception {
        var apiUpdateApplicationRequest = TestModelDataBuilder.getApiProcessRepOrderRequest(!IS_VALID);
    ...
    void givenValidEitherWayCaseTypeContent_whenProcessRepOrderIsInvoked_thenSuccess() throws Exception {
        ...
        assertThat(result.getResponse().getContentAsString())
                .isEqualTo(objectMapper.writeValueAsString(TestModelDataBuilder.getApiProcessRepOrderResponse()));
    }
    ...
    void givenEmptyOAuthToken_whenUpdateApplicationIsInvoked_thenFailsUnauthorizedAccess() throws Exception {
        mvc.perform(RequestBuilderUtils.buildRequestGivenContent(HttpMethod.PUT, "{}", ENDPOINT_URL, Boolean.FALSE))
                .andExpect(status().isUnauthorized());
    }
    ...
    @Test
    void givenIndictableCaseTypeAndMagistratesOutcomeIsEmpty_whenUpdateIsInvoked_thenFailsBadRequest()
            throws Exception {
        ...
        wiremock.stubFor(get(urlMatching("/api/internal/v1/assessment/rep-orders/cc-outcome/.*"))
                .willReturn(WireMock.ok()
                        .withHeader("Content-Type", String.valueOf(MediaType.APPLICATION_JSON))
                        .withBody(objectMapper.writeValueAsString(List.of(TestModelDataBuilder.getRepOrderCCOutcomeDTO(
                                1,
    ...
    void givenValidContent_whenUpdateIsInvoked_thenUpdateIsSuccess() throws Exception {
        ...
        mvc.perform(RequestBuilderUtils.buildRequestGivenContent(
                ...
                .andExpect(
                        jsonPath("$.crownCourtSummary.evidenceFeeLevel").value(EvidenceFeeLevel.LEVEL1.getFeeLevel()))
                .andExpect(jsonPath("$.crownCourtSummary.repOrderCrownCourtOutcome[0].outcome")
