...
class UpdateRepOrderDTOBuilderTest {
    ...
    void givenCrownCourtDTO_whenBuildIsInvoked_thenCorrectUpdateRepOrderRequestDTOFieldsArePopulated() {
        ...
        softly.assertThat(updateRequest.getCrownRepOrderType()).isEqualTo(apiProcessRepOrderResponse.getRepType());
    ...
    void givenCrownCourtDTOAndMagsDecisionResult_whenBuildInvoked_thenUpdateRepOrderDTOFieldsMappedCorrectly() {
        ...
        softly.assertThat(updateRequest.getRepId()).isEqualTo(dto.getRepId());
        softly.assertThat(updateRequest.getDecisionDate()).isEqualTo(magsDecisionResult.getDecisionDate());
        softly.assertThat(updateRequest.getDecisionReasonCode()).isEqualTo(magsDecisionResult.getDecisionReason());
        softly.assertThat(updateRequest.getUserModified())
                .isEqualTo(dto.getUserSession().getUserName());
        softly.assertAll();
    }
