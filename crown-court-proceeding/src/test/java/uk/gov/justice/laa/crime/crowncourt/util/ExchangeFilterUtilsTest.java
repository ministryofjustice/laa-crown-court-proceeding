...
class ExchangeFilterUtilsTest {
    ...
    private static final String LOGGER_NAME = "uk.gov.justice.laa.crime.crowncourt.util";
    ...
    void givenClientRequest_whenLogRequestHeadersIsInvoked_thenCorrectHeadersAreLogged() {
        ...
        ExchangeFilterUtils.logRequestHeaders().filter(request, exchangeFunction);
    ...
    void random() {
        ...
        Mono<ClientResponse> response =
                ExchangeFilterUtils.logResponse().filter(request, exchangeFunction);
        response.block();
    ...
    void givenNotFoundStatus_whenHandleErrorResponseIsInvoked_thenWebClientResponseExceptionIsThrown() {
        ...
        Mono<ClientResponse> response = ExchangeFilterUtils.handleErrorResponse()
    ...
    void givenRetriesExhausted_whenRetryFilterIsInvoked_thenAPIClientExceptionIsThrown() {
        ...
        Mono<ClientResponse> response =
                ExchangeFilterUtils.retryFilter(retryConfiguration).filter(request, exchangeFunction);
