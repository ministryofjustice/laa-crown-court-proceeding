...
class DeadLetterMessageReportServiceTest {
    ...
    public static final Sort DEAD_LETTER_SORT = Sort.by("deadLetterReason").ascending().and(Sort.by("receivedTime").descending());
    ...
    void testGenerateReportContents_LinesMatchAsExpected()  {
        ...
        List<DeadLetterMessageEntity> deadLetterMessageList = List.of(deadLetterMessageEntity1, 
            deadLetterMessageEntity2, deadLetterMessageEntity3);
