...
class ResultCodeHelperTest {
    ...
    @InjectMocks private ResultCodeHelper resultCodeHelper;

    @Mock private CourtDataAPIService courtDataAPIService;

    @Test
    void testWhenCCOutcomeIsConvictedAndResultCodeWithNonImp_thenReturnN() {
        when(courtDataAPIService.fetchResultCodesForCCImprisonment())
                .thenReturn(imprisonmentResultCodes());
    ...
    void whenCCOutcomeIsPartConvictedAndResultCodeWithImp_thenFlagIsY() {
        when(courtDataAPIService.fetchResultCodesForCCImprisonment())
                .thenReturn(imprisonmentResultCodes());
        String imprisoned =
                resultCodeHelper.isImprisoned(PART_CONVICTED.getValue(), HEARING_RESULT_CODES);
    ...
    void whenCCOutcomeIsAquittedAndResultCodeWithImp_thenFlagIsNull() {
        String imprisoned =
                resultCodeHelper.isImprisoned(AQUITTED.getValue(), HEARING_RESULT_CODES);
    ...
    void whenCCOutcomeIsConvictedAndResultCodeWithBW_thenReturnY() {
        ...
        String status =
                resultCodeHelper.isBenchWarrantIssued(CONVICTED.getValue(), HEARING_RESULT_CODES);
    ...
    void whenCCOutcomeIsConvictedAndResultCodeWithBW_thenReturnNull() {
        when(courtDataAPIService.findByCjsResultCodeIn()).thenReturn(imprisonmentResultCodes());
        String status =
                resultCodeHelper.isBenchWarrantIssued(CONVICTED.getValue(), List.of("1111"));
    ...
    void whenCCOutcomeIsAquittedAndResultCodeWithBW_thenReturnY() {
        when(courtDataAPIService.findByCjsResultCodeIn()).thenReturn(imprisonmentResultCodes());
        String status =
                resultCodeHelper.isBenchWarrantIssued(AQUITTED.getValue(), HEARING_RESULT_CODES);
        assertThat(status).isEqualTo("Y");
    }
    ...
    void whenCCOutcomeIsPartCAndResultCodeWithBW_thenReturnY() {
        when(courtDataAPIService.findByCjsResultCodeIn()).thenReturn(imprisonmentResultCodes());
        String status =
                resultCodeHelper.isBenchWarrantIssued(PART_CONVICTED.getValue(), List.of("1016"));
        assertThat(status).isEqualTo("Y");
    }
    ...
    void whenCCOutcomeIsPartCAndResultCodeWithBW_thenBWarFlagIsNull() {
        when(courtDataAPIService.findByCjsResultCodeIn()).thenReturn(imprisonmentResultCodes());
        String status =
                resultCodeHelper.isBenchWarrantIssued(PART_CONVICTED.getValue(), List.of("4545"));
        assertThat(status).isNull();
    }
