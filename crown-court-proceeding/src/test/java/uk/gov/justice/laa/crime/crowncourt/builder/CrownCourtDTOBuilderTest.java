...
class CrownCourtDTOBuilderTest {
    ...
    @Test
    void
            givenApiProcessRepOrderRequest_whenBuildIsInvoked_thenCorrectCrownCourtDTOFieldsArePopulated() {
        ApiProcessRepOrderRequest request = TestModelDataBuilder.getApiProcessRepOrderRequest(true);
    ...
    @Test
    void
            givenApiUpdateApplicationRequest_whenBuildIsInvoked_thenCorrectCrownCourtDTOFieldsArePopulated() {
        ApiUpdateApplicationRequest request =
                TestModelDataBuilder.getApiUpdateApplicationRequest(true);
        CrownCourtDTO dto = CrownCourtDTOBuilder.build(request);
    ...
    @Test
    void
            givenApiUpdateCrownCourtRequest_whenBuildIsInvoked_thenCorrectCrownCourtDTOFieldsArePopulated() {
        ApiUpdateCrownCourtRequest request =
                TestModelDataBuilder.getApiUpdateCrownCourtRequest(true);
        CrownCourtDTO dto = CrownCourtDTOBuilder.build(request);
        checkCommonFields(request, dto);
        ...
        softly.assertThat(dto.getCapitalEvidence())
                .isEqualTo(
                        List.of(
                                TestModelDataBuilder.getCapitalEvidenceDTO(
                                        TestModelDataBuilder.TEST_DATE_RECEIVED, "Type")));
        softly.assertThat(dto.getIncomeEvidenceReceivedDate())
                .isEqualTo(TestModelDataBuilder.INCOME_EVIDENCE_DATE);
        softly.assertThat(dto.getCapitalEvidenceReceivedDate())
                .isEqualTo(TestModelDataBuilder.CAPITAL_EVIDENCE_DATE);
