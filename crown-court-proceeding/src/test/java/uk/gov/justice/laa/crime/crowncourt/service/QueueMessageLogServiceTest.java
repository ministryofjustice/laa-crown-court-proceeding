...
class QueueMessageLogServiceTest {
    ...
    @InjectMocks private QueueMessageLogService queueMessageLogService;
    @Spy private QueueMessageLogRepository queueMessageLogRepository;
    @Captor private ArgumentCaptor<QueueMessageLogEntity> queueMessageCaptor;
    ...
    void testWhenProsecutionConcluded_thenCheckLogEntryCreated() {
        ...
        assertAll(
                ...
                () ->
                        assertEquals(
                                "8720c683-39ef-4168-a8cc-058668a2dcca",
                                savedQueueMsg.getLaaTransactionId()),
    ...
    void testWhenMetadataIsNull_thenProcessAsExpected() {
        ...
        queueMessageLogService.createLog(
                MessageType.PROSECUTION_CONCLUDED, newQueueMessageWithoutMetaData(maatId));
