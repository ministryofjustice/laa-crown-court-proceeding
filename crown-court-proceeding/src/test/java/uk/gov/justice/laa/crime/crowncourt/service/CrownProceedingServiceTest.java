...
class CrownProceedingServiceTest {
    ...
    @InjectMocks private CrownProceedingService crownProceedingService;

    @Mock private RepOrderService repOrderService;
    ...
    @Test
    void
            givenValidEitherWayCaseWithCommittedMagOutcome_whenProcessRepOrderIsInvoked_validResponseIsReturned() {
        CrownCourtDTO requestDTO = TestModelDataBuilder.getCrownCourtDTO();
    ...
    @Test
    void
            givenValidEitherWayCaseWithCommittedForTrailMagOutcome_whenProcessRepOrderIsInvoked_validResponseIsReturned() {
        CrownCourtDTO requestDTO = TestModelDataBuilder.getCrownCourtDTO();
        requestDTO.setCaseType(CaseType.EITHER_WAY);
    ...
    @Test
    void
            givenValidEitherWayCaseWithSentForTrailMagOutcome_whenProcessRepOrderIsInvoked_validResponseIsReturned() {
        CrownCourtDTO requestDTO = TestModelDataBuilder.getCrownCourtDTO();
        requestDTO.setCaseType(CaseType.EITHER_WAY);
    ...
    @Test
    void
            givenValidEitherWayCaseWithAppealToCCMagOutcome_whenProcessRepOrderIsInvoked_validResponseIsReturned() {
        CrownCourtDTO requestDTO = TestModelDataBuilder.getCrownCourtDTO();
        requestDTO.setCaseType(CaseType.EITHER_WAY);
    ...
    @Test
    void
            givenEitherWayCaseWithResolvedMagOutcome_whenProcessRepOrderIsInvoked_emptyResponseIsReturned() {
        CrownCourtDTO requestDTO = TestModelDataBuilder.getCrownCourtDTO();
        requestDTO.setCaseType(CaseType.EITHER_WAY);
    ...
    void givenAValidRepIdAndNoOutcomeRecord_whenGetCCOutcomeIsInvoked_thenReturnEmpty() {
        ...
        List<RepOrderCCOutcomeDTO> repOrderCCOutcomeDTOList =
                crownProceedingService.getCCOutcome(TestModelDataBuilder.TEST_REP_ID);
    ...
    void givenAValidRepId_whenGetCCOutcomeIsInvoked_thenReturnOutcomeInNaturalOrder() {
        ...
        outcomeList.add(
                TestModelDataBuilder.getRepOrderCCOutcomeDTO(
                        2,
                        CrownCourtOutcome.CONVICTED.getCode(),
        ...
        outcomeList.add(
                TestModelDataBuilder.getRepOrderCCOutcomeDTO(
                        1,
                        CrownCourtOutcome.SUCCESSFUL.getCode(),
        ...
        softly.assertThat(repOrderCCOutcomeDTOList.get(0).getOutcome())
                .isEqualTo(CrownCourtOutcome.PART_CONVICTED.getCode());
        softly.assertThat(repOrderCCOutcomeDTOList.get(0).getDescription())
                .isEqualTo(CrownCourtOutcome.PART_CONVICTED.getDescription());
        softly.assertThat(repOrderCCOutcomeDTOList.get(0).getOutcomeDate())
                .isEqualTo(LocalDateTime.of(2022, 2, 7, 9, 1, 25));

        softly.assertThat(repOrderCCOutcomeDTOList.get(1).getOutcome())
                .isEqualTo(CrownCourtOutcome.SUCCESSFUL.getCode());
        softly.assertThat(repOrderCCOutcomeDTOList.get(1).getDescription())
                .isEqualTo(CrownCourtOutcome.SUCCESSFUL.getDescription());
        softly.assertThat(repOrderCCOutcomeDTOList.get(1).getOutcomeDate())
                .isEqualTo(LocalDateTime.of(2022, 3, 7, 10, 1, 25));

        softly.assertThat(repOrderCCOutcomeDTOList.get(2).getOutcome())
                .isEqualTo(CrownCourtOutcome.CONVICTED.getCode());
        softly.assertThat(repOrderCCOutcomeDTOList.get(2).getDescription())
                .isEqualTo(CrownCourtOutcome.CONVICTED.getDescription());
    ...
    void givenAValidRepIdAndEmptyOutcome_whenGetCCOutcomeIsInvoked_thenReturnOutcome() {
        ...
        outcomeList.add(
                TestModelDataBuilder.getRepOrderCCOutcomeDTO(
                        2, null, LocalDateTime.of(2023, 2, 7, 15, 1, 25)));
    ...
    @Test
    void
            givenAValidRepIdAndInvalidCrownCourtOutcome_whenGetCCOutcomeIsInvoked_thenReturnOutcomeInNaturalOrder() {
        List<RepOrderCCOutcomeDTO> outcomeList = new ArrayList<>();
        outcomeList.add(
                TestModelDataBuilder.getRepOrderCCOutcomeDTO(
                        2, "", LocalDateTime.of(2023, 2, 7, 15, 1, 25)));
        outcomeList.add(
                TestModelDataBuilder.getRepOrderCCOutcomeDTO(
                        3,
                        CrownCourtOutcome.PART_CONVICTED.getCode(),
    ...
    void givenAInput_whenUpdateIsInvoked_thenReturnResponse() {
        ...
        when(repOrderService.updateCCOutcome(any()))
                .thenReturn(TestModelDataBuilder.getRepOrderDTO());
        List<RepOrderCCOutcomeDTO> outcomeList = new ArrayList<>();
        outcomeList.add(
                TestModelDataBuilder.getRepOrderCCOutcomeDTO(
        ...
        assertThat(response.getModifiedDateTime())
                .isEqualTo(TestModelDataBuilder.TEST_DATE_MODIFIED);
        ...
        assertThat(summary.getRepOrderCrownCourtOutcome().get(0).getOutcome())
                .isEqualTo(CrownCourtOutcome.CONVICTED);
