...
class ResultDTOBuilderTest {
    ...
    void givenAHearingResult_whenBuildIsInvoked_thenReturnWQHearingDTO(
            HearingResultResponse hearingResult,
    ...
    private static Stream<Arguments> getHearingResultScenarios() {
        ...
        HearingResultResponse invalidProsecutionCase =
                TestModelDataBuilder.getHearingResultResponse(false, false, false);
        ...
        emptyResult
                ...
                .getJudicial_results()
                .get(0)
                .setIs_convicted_result(null);

        return Stream.of(
                Arguments.of(null, getProsecutionConcluded(), Collections.emptyList()),
                Arguments.of(
                        HearingResultResponse.builder().build(),
                        ProsecutionConcluded.builder().build(),
                        Collections.emptyList()),
                Arguments.of(
                        TestModelDataBuilder.getHearingResultResponse(true, false, false),
                        getProsecutionConcluded(),
                        Collections.emptyList()),
                Arguments.of(
                        TestModelDataBuilder.getHearingResultResponse(true, true, false),
                        getProsecutionConcluded(),
                        Collections.emptyList()),
                ...
                Arguments.of(
                        TestModelDataBuilder.getHearingResultResponse(true, true, true),
                        getProsecutionConcluded(),
                        List.of(Result.builder().isConvictedResult(Boolean.TRUE).build())));
    }
