...
class UpdateApiResponseBuilderTest {
    ...
    void givenAValidInput_whenBuildIsInvoked_thenReturnApiUpdateCrownCourtOutcomeResponse() {
        ...
        List<RepOrderCCOutcomeDTO> repOrderCCOutcomeList = List.of(TestModelDataBuilder.getRepOrderCCOutcomeDTO(
        ...
        softly.assertThat(crownCourtSummary
        ...
        softly.assertThat(
                        crownCourtSummary.getRepOrderCrownCourtOutcome().get(0).getOutcomeDate())
