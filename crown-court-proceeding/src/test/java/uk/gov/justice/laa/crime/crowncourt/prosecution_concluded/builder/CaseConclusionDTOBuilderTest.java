...
class CaseConclusionDTOBuilderTest {
    ...
    @InjectMocks private CaseConclusionDTOBuilder caseConclusionDTOBuilder;
    ...
    void givenAValidOffenceSummary_whenGetMostRecentCaseEndDateIsInvoked_thenCorrectDateIsReturn() {
        ...
        List<OffenceSummary> offenceSummaryList = new ArrayList<>();
        offenceSummaryList.add(
                TestModelDataBuilder.getOffenceSummary(UUID.randomUUID(), "2023-01-01"));
        offenceSummaryList.add(
                TestModelDataBuilder.getOffenceSummary(UUID.randomUUID(), "2022-02-02"));
        assertThat(caseConclusionDTOBuilder.getMostRecentCaseEndDate(offenceSummaryList))
                .isEqualTo("2023-01-01");
    }

    @Test
    void givenANullResultCode_whenBuildResultCodeListIsInvoked_thenEmptyIsReturn() {
        assertThat(caseConclusionDTOBuilder.buildResultCodeList(WQHearingDTO.builder().build()))
                .isEqualTo(List.of(""));
    }
    ...
    void givenAValidResultCode_whenBuildResultCodeListIsInvoked_thenCorrectValueIsReturn() {
        assertThat(
                        caseConclusionDTOBuilder.buildResultCodeList(
                                WQHearingDTO.builder().resultCodes("code1,code2,code3").build()))
    ...
    void givenAValidProsecutionConcluded_whenBuildIsInvoked_thenReturnConcludedDTO() {
        ConcludedDTO concludedDTO =
                caseConclusionDTOBuilder.build(
                        TestModelDataBuilder.getProsecutionConcluded(),
                        TestModelDataBuilder.getWQHearingDTO(),
                        "2022-01-01",
                        "121");
        ...
        softly.assertThat(concludedDTO.getHearingResultCodeList())
                .isEqualTo(List.of("code1", "code2", "code3"));
        softly.assertThat(concludedDTO.getProsecutionConcluded())
                .isEqualTo(TestModelDataBuilder.getProsecutionConcluded());
        softly.assertAll();
    }
}
