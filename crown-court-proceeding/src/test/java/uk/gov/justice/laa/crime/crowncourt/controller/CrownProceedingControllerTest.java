...
class CrownProceedingControllerTest {
    ...
    @MockBean private CrownProceedingService crownProceedingService;

    @MockBean private CrownCourtDetailsValidator crownCourtDetailsValidator;
    ...
    void updateApplication_Success() throws Exception {
        ...
        var updateApplicationRequestJson =
    ...
    @Test
    void givenARequestBodyIsMissing_whenUpdateCrownCourtIsInvoked_thenReturnServerError()
            throws Exception {
        mvc.perform(
                        RequestBuilderUtils.buildRequestGivenContent(
    ...
    @Test
    void givenAInValidInput_whenUpdateCrownCourtIsInvoked_RequestObjectFailsValidation()
            throws Exception {
        var apiUpdateCrownCourtRequest =
                TestModelDataBuilder.getApiUpdateCrownCourtRequest(!IS_VALID);
        var updateApplicationRequestJson =
        ...
        mvc.perform(
                        RequestBuilderUtils.buildRequestGivenContent(
                                HttpMethod.PUT,
                                updateApplicationRequestJson,
                                UPDATE_CC_ENDPOINT_URL))
                .andExpect(status().is4xxClientError());
    }

    @Test
    void
            givenAnInput_whenUpdateCrownCourIsInvokedAndValidationFails_thenBadRequestResponseIsReturned()
                    throws Exception {
        var apiUpdateCrownCourtRequest =
                TestModelDataBuilder.getApiUpdateCrownCourtRequest(IS_VALID);
        var updateApplicationRequestJson =
