...
public class RepOrderService {
    ...
    List<String> grantedRepOrderDecisions = List.of(
            Constants.GRANTED_FAILED_MEANS_TEST, Constants.GRANTED_PASSED_MEANS_TEST, Constants.GRANTED_PASSPORTED);
            ...
            switch (requestDTO.getCaseType()) {
                ...
                case APPEAL_CC -> {
                    IOJAppealDTO iojAppealDTO =
                            maatCourtDataService.getCurrentPassedIOJAppealFromRepId(requestDTO.getRepId());
            ...
            if (null != request.getMagCourtOutcome()
                ...
                if (null != evidenceFeeResponse.getEvidenceFee()) {
                    dto.getCrownCourtSummary()
                            .setEvidenceFeeLevel(EvidenceFeeLevel.getFrom(
