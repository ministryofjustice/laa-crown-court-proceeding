...
public class DeadLetterMessageReportService {
    ...
    private static final String FILE_NAME_TEMPLATE =
            "Dropped_Prosecution_Concluded_Messages_Report_%s-%s";
    ...
    public void generateReport() throws IOException, NotificationClientException {
        ...
        String fileName =
                String.format(
                        FILE_NAME_TEMPLATE,
                        startTime.format(dateRangeFormatter),
    ...
    private List<String> prepareLinesForCsv(List<DeadLetterMessageEntity> deadLetterMessageList) {
        ...
        lines.addAll(
                deadLetterMessageList.stream()
                        .map(
                                deadLetterMessage ->
                                        deadLetterMessage.getMessage().getMaatId()
                                                + ","
    ...
    private List<String> generateSummary(List<DeadLetterMessageEntity> deadLetterMessageList) {
        ...
        summary.add(
                startTime.format(dateRangeFormatter) + " to " + endTime.format(dateRangeFormatter));
