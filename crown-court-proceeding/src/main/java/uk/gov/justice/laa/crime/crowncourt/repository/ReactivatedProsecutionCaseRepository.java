...
public interface ReactivatedProsecutionCaseRepository
        extends JpaRepository<ReactivatedProsecutionCase, Integer> {
    boolean existsByMaatIdAndReportingStatus(Integer maatId, String reportingStatus);

    Optional<ReactivatedProsecutionCase> findByMaatIdAndReportingStatus(
            Integer maatId, String reportingStatus);
