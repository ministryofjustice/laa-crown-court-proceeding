...
public class CrimeEvidenceDataService {
    ...
    public ApiCalculateEvidenceFeeResponse calculateEvidenceFee(
            ApiCalculateEvidenceFeeRequest evidenceFeeRequest) {
        log.debug("Request to calculate evidence fee: {}", evidenceFeeRequest);
        ApiCalculateEvidenceFeeResponse response =
                evidenceAPIClient.calculateEvidenceFee(evidenceFeeRequest);
